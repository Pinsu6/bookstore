  ...
  return (
    <>
      <div className="max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row">
        <div className="w-full md:w-1/2 mt-32 md:mt-30 order-2 md:order-1 ">
          <div className="space-y-12">
            ...
            <p className="text-xl">
              ...
              eum molestiae quis dolorem officiis accusantium facere atque
              quisquam optio.
            </p>
            <label className="input input-bordered flex items-center gap-3 w-3/4">
              <svg
